...
A summary of locations and covariates collected can be found in @tbl-paired. Species richness overall did not change significantly following burns. Paired pre- and post-burn comparisons across locations showed no systematic increase or decrease in richness (Wilcoxon signed-rank test, *V* = 19.5, *p* = 0.44).
...
#| message: false
#| label: fig-tsf
#| tbl-cap: Species abundance in relation to years since fire.
